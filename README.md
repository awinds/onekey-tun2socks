...
```bash
curl -L https://raw.githubusercontent.com/awinds/onekey-tun2socks/main/onekey-tun2socks.sh -o onekey-tun2socks.sh && chmod +x onekey-tun2socks.sh && sudo ./onekey-tun2socks.sh -i alice
```
...
```bash
curl -L https://raw.githubusercontent.com/awinds/onekey-tun2socks/main/onekey-tun2socks.sh -o onekey-tun2socks.sh && chmod +x onekey-tun2socks.sh && sudo ./onekey-tun2socks.sh -i legend
```

### 卸载
```bash
curl -L https://raw.githubusercontent.com/awinds/onekey-tun2socks/main/onekey-tun2socks.sh -o onekey-tun2socks.sh && chmod +x onekey-tun2socks.sh && sudo ./onekey-tun2socks.sh -r
```
...
1. 下载脚本：
```bash
curl -L https://raw.githubusercontent.com/awinds/onekey-tun2socks/main/onekey-tun2socks.sh -o onekey-tun2socks.sh
```
